 ...
 */
export function computePolynomialSlopeAndOffset(min: number, max: number, nbChannels: number): {polynomialSlope: number, polynomialOffset: number} {
 ...
 */
function decomposeFloatToUint24(floatValue: number, polynomialSlope: number, polynomialOffset: number): [number, number, number] {
 ...
 */
export function floatRasterToMultiChannelRaster(floatRaster: FloatRaster, options: FloatRasterToMultiChannelRasterOptions): MultiChannelRaster {
